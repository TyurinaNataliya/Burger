...
const listEl = document.getElementById('contactList') as HTMLDivElement;
const openToggleEl = document.getElementById('openNowToggle') as HTMLInputElement;
const allDayToggleEl = document.getElementById('allDayToggle') as HTMLInputElement;
const hintEl = document.getElementById('filterHint') as HTMLParagraphElement;
...
function isOpenNow(contact: Contact): boolean {
...
function statusBadge(contact: Contact): string {
    if (contact.alwaysOpen) {
